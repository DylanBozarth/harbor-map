...
const MapComponent = ({
  ...
  // We use this method in order to get around the CORS issue of browser requests. Do not use this in prod for your app/website. 
  ...
  /*  This is the function that can be used on your backend to fetch the latest data from our API 
  const fetchLocalLocations = async () => {
    setIsLoading(true)
    try {
